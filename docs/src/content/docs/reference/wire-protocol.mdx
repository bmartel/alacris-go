...
page id is in a URL and therefore in access logs — and on its own it reaches
...
{"p":"PAZlOnTCMes0TtjTNqisWV0V","a":"add-todo","i":"todos","d":{"text":"buy milk"}}
```
...
The capability is a cookie, which the browser attaches to whatever a page can
cause — the property CSRF is built on. Three things replace the secret that
used to sit in the body:
