...
This is the part that makes server rendering useful. Because object defaults
are parsed with `JSON.parse`, a struct or a map crosses as an attribute. No
post-load property assignment, no hydration payload, and a page that is
