        ...
        // vendors. What runs here is what your server would serve.
        {
          ...
          content: JSON.stringify({
            imports: {
              ...
              '@alacris/ui': `${BASE}/lib/ui/index.js`,
              '@alacris/ui/theme': `${BASE}/lib/ui/theme/index.js`,
              '@alacris/ui/motion': `${BASE}/lib/ui/motion/index.js`,
              '@alacris/ui/tokens': `${BASE}/lib/ui/tokens/index.js`,
              '@alacris/ui/components/': `${BASE}/lib/ui/components/`,
            },
          }),
        },
      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Alacris UI', slug: 'guides/alacris-ui' },
